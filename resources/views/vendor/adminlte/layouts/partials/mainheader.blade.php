                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{ Auth::user()->name }}
                                    <small>@lang('home.usu1'){{ Auth::user()->rol }}</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
                                <div class="col-xs-4 text-center">
                                    <a href="#">@lang('home.seguidores')</a>
                                </div>
                                <div class="col-xs-4 text-center">
                                    <a href="#">@lang('home.ventas')</a>
                                </div>
                                <div class="col-xs-4 text-center">
                                    <a href="#">@lang('home.amigos')</a>
                                </div>
                            </li>
                            <!-- Menu Footer-->
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ url('/usuario/'.Auth::user()->id.'/edit') }}" class="btn btn-default btn-flat">@lang('home.profile')</a>
                                </div>
                                <div class="pull-right">
                                    <a href="{{ url('/logout') }}" class="btn btn-default btn-flat">@lang('home.salir')</a>
                                </div>
                            </li>
                        </ul>
